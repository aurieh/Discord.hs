...
module Network.Discord.Framework where
  ...
  data D.Client c => Handle c = Null
                              ...
                              | MessageReactionAddEvent       (Object  -> Effect DiscordM ())
                              | MessageReactionRemoveEvent    (Object  -> Effect DiscordM ())
                              | MessageReactionRemoveAllEvent (Object  -> Effect DiscordM ())
  ...
  handle a@(MessageUpdateEvent p)           (D.MessageUpdate o)
    = runAsync (clientProxy a) $ p o
  handle a@(MessageReactionAddEvent p)      (D.MessageReactionAdd o)
    = runAsync (clientProxy a) $ p o
  handle a@(MessageReactionRemoveEvent p)   (D.MessageReactionRemove o)
    = runAsync (clientProxy a) $ p o
  handle a@(MessageReactionRemoveAllEvent p) (D.MessageReactionRemoveAll o)
    = runAsync (clientProxy a) $ p o
